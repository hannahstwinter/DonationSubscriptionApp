...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { agency_data: @agency.agency_data, name: @agency.name, password: @agency.password, username: @agency.username }
    end
  ...
  test "should update agency" do
    patch :update, id: @agency, agency: { agency_data: @agency.agency_data, name: @agency.name, password: @agency.password, username: @agency.username }
    assert_redirected_to agency_path(assigns(:agency))
  end
